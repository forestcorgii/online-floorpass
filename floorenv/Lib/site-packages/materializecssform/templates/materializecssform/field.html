...
<div class="input-field col {{ classes.label }} {{ classes.value }} {{ classes.single_value }}">
    ...
    <input type="date" id="{{ field.auto_id }}" name="{{ field.html_name }}" class="datepicker"
           value="{% if field.value %}{% localize off %}{{ field.value }}{% endlocalize %}{% endif %}" {% include
    'materializecssform/attrs.html' %} >
...
<div class="input-field col {{ classes.label }} {{ classes.value }} {{ classes.single_value }}">
    ...
    <input type="datetime-local" id="{{ field.auto_id }}" name="{{ field.html_name }}"
           value="{% if field.value %}{{ field.value|date:'c' }}{% endif %}" {% include 'materializecssform/attrs.html'
    %} >
    <label for="{{ field.id_for_label }}">{{ field.label }}</label>
...
<div class="input-field col {{ classes.label }} {{ classes.value }} {{ classes.single_value }}">
    ...
    {% include 'materializecssform/field_icon.html' %}
    {% endif %}
    <textarea id="{{ field.auto_id }}" class="materialize-textarea" name="{{field.html_name}}" {% include
    'materializecssform/attrs.html' %} >{% if field.value %}{{ field.value }}{% endif %}</textarea>
    {% if field.auto_id %}
    <label class="{% if field.field.required %}{{ form.required_css_class }}{% endif %}" for="{{ field.auto_id }}">{{
        field.label }}</label>
    {% endif %}
